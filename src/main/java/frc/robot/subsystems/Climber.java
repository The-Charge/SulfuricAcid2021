...
public class Climber extends SubsystemBase {
    ...
    public void limitCurrent() {
        ...
        climberMotor.configPeakCurrentLimit(PEAK_CURRENT_LIMIT); // don't activate current limit until current exceeds
                                                                 // 30 A ...
        climberMotor.configPeakCurrentDuration(PEAK_CURRENT_DURATION); // ... for at least 100 ms
        climberMotor.configContinuousCurrentLimit(CONTINUOUS_CURRENT_LIMIT); // once current-limiting is actived, hold
                                                                             // at 20A
        climberMotor.enableCurrentLimit(true);
        // Enabling Current Limit means the Talon SRX will automatically monitor the
        // current output
