...
public class RobotContainer {
    ...
    private RobotContainer() {
        ...
        SmartDashboard.putData("SetTurretElevationExtension: Minimum",
                new SetTurretElevationExtension(0, m_turretElevation));
        SmartDashboard.putData("SetTurretElevationExtension: Maximum",
                new SetTurretElevationExtension(1, m_turretElevation));
