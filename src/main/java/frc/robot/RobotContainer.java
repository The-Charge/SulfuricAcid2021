...
public class RobotContainer {
    ...
    private void smartDashboardButtons() {
        ...
        // SmartDashboard.putData("GalacticSearchRedA", new GalacticSearchRedA(
        // drivetrain, intake, indexer ));
        // SmartDashboard.putData("GalacticSearchRedB", new GalacticSearchRedB(
        // drivetrain, intake, indexer ));
        // SmartDashboard.putData("GalacticSearchBlueB", new GalacticSearchBlueB(
        // drivetrain, intake, indexer ));
        // SmartDashboard.putData("GalacticSearchBlueA", new GalacticSearchBlueA(
        // drivetrain, intake, indexer ));
    ...
    private void configureButtonBindings() {
        ...
        // new WaitCommand(1), new ClimberRun(climber, 0.7))));
        ...
        // m_chooser.setDefaultOption("Slalom", new Slalom(drivetrain, stopper, indexer,
        // shooter, turret, intake));
