...
public class Constants {
    public static final class DriveConstants {
      ...
      //TODO test/tune these values
        ...
        public static final double kPDriveVel = 1.31; //1.31 slalom and barrel -- 0.7 for bounce
      }
      ...
      public static final class AutoConstants {
        ...
        public static final double kMaxSpeedMetersPerSecond = 1.0; //2.0 for slalom, 2.0 for barrel 1.5 for bounce
        public static final double kMaxAccelerationMetersPerSecondSquared = 0.5; //0.6 slalom, 0.5 for barrel, 0.55 for bounce
