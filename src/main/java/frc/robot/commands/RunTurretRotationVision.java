...
public class RunTurretRotationVision extends CommandBase {
    ...
    public RunTurretRotationVision(TurretRotation subsystem) {
        ...
        // TODO: set this up to work with multiple subsystems. Will visionLights be required once or constantly?
    ...
    public void execute() {
        if (m_visionTargetInterface.success()) {
            boolean locked = m_turretRotation.turnToRelativeAngle(m_visionTargetInterface.get(VisionTargetInterface.Key.HORIZONTAL_ANGLE));
