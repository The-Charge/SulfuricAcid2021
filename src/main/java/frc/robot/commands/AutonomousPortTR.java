 ...
 *
 */
public class AutonomousPortTR extends SequentialCommandGroup {

    Drivetrain m_drivetrain;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public AutonomousPortTR(Drivetrain drivetrain) {

        // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        m_drivetrain = drivetrain;
        addCommands(getAutonomousPortTR());
    }
    ...
    public Command getAutonomousPortTR() {
        ...
        try {
            ...
            exampleTrajectory = exampleTrajectory.transformBy(
                    new Transform2d(new Pose2d(0, 0, new Rotation2d(0)), new Pose2d(-4, 6, new Rotation2d(0))));
            System.out.println(exampleTrajectory);
