...
public class XPercentSpeed extends InstantCommand {
    ...
    private final double m_speedMult; // The coefficient that the speed of the Drivetrain will be multiplied by
                                      // (between 0 and 1). This number doesn't matter if the function is turning off
                                      // the drive mode
