...
public class GalacticSearchBlueA extends SequentialCommandGroup {
    ...
    public GalacticSearchBlueA(Drivetrain drivetrain, Intake intake, Indexer indexer){
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        addCommands(
            getAutonomous()
            //factory.getAutonIntake(intake)
            //parallel(getAutonomous(), factory.getAutonIntake(intake))
        );
    } 
    ...
    private Command getAutonomous() {
        ...
        Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
          ...
          String trajectoryJSON = "paths/galacticBlueA.wpilib.json";
