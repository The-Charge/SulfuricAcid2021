 ...
 *
 */
public class AutonomousNew extends SequentialCommandGroup {

    Drivetrain m_drivetrain;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public AutonomousNew(Drivetrain drivetrain) {

        // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        m_drivetrain = drivetrain;
        addCommands(getAutonomousNew());
    }
    ...
    public Command getAutonomousNew() {
        ...
        Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
                ...
                List.of(new Translation2d(.5, 0), new Translation2d(1, -1), new Translation2d(1, -3)),
