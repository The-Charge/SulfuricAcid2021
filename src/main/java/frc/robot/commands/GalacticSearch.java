                ...
                parallel(
                    ...
                    new InstantCommand(() -> m_drivetrain.resetOdometry(new Pose2d(0, 0, new Rotation2d(0)))).andThen(
                        getSegment(
                            ...
                            List.of(new Translation2d(3.8, -1.4), new Translation2d(4.7, 0.8), new Translation2d(6.1, 0)),
                            false
                        )
                    )
                )
            ...
            addCommands(
                parallel(
                    ...
                    new InstantCommand(() -> m_drivetrain.resetOdometry(new Pose2d(0, 0, new Rotation2d(0)))).andThen(
                        getSegment(
                            new Pose2d(0, 0, new Rotation2d(0)),
                            new Pose2d(7.6, 1.5, new Rotation2d(-Math.PI/4)),
                            List.of(new Translation2d(3.8,-0.8), new Translation2d(5.3,0.8), new Translation2d(6.6, -0.8)),
                            false
                        )
                    )
                )
