...
public class Slalom extends SequentialCommandGroup {
    ...
    public Slalom(Drivetrain drivetrain, Stopper stopper, Indexer indexer, Shooter shooter, Turret turret) {

        // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        m_drivetrain = drivetrain;
        factory = new AutonCommandFactory();
        addCommands(factory.shootFor(7, stopper, indexer, shooter, turret),
                new InstantCommand(drivetrain::resetEncoders).andThen(getAutonomous()));
    }
    ...
    private Command getAutonomous() {
        ...
        // String trajectoryJSON = "output/galacticBlueB.wpilib.json";
